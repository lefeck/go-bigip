...
type LicenseData struct {
	NestedStats   NestedStatsLicense              `json:"nestedStats,omitempty"`
	ActiveModules NestedStatsActiveModulesWrapper `json:"https://localhost/mgmt/tm/sys/license/0/active-modules,omitempty"`
}

type NestedStatsLicense struct {
	Entries map[string]DescriptionOrValue `json:"entries,omitempty"`
}

type NestedStatsActiveModules struct {
...
type NestedStatsActiveModulesWrapper struct {
	NestedStats NestedStatsActiveModules `json:"nestedStats,omitempty"`
}

type License struct {
	Kind     string                 `json:"kind"`
	SelfLink string                 `json:"selfLink"`
	Entries  map[string]LicenseData `json:"entries,omitempty"`
}
