...
func (r *PFManResource) ListAll() (*PFManConfigList, error) {
	...
	if err := r.c.ReadQuery(bigip.GetBaseResource()+PFManEndpoint, &list); err != nil {
		return nil, err
	}
	return &list, nil
}
...
func (r *PFManResource) Get(id string) (*PFManConfig, error) {
	...
	if err := r.c.ReadQuery(bigip.GetBaseResource()+PFManEndpoint, &item); err != nil {
		return nil, err
	}
	return &item, nil
}
...
func (r *PFManResource) Create(item PFManConfig) error {
	if err := r.c.ModQuery("POST", bigip.GetBaseResource()+PFManEndpoint, item); err != nil {
		return err
	}
	return nil
}
...
func (r *PFManResource) Edit(id string, item PFManConfig) error {
	if err := r.c.ModQuery("PUT", bigip.GetBaseResource()+PFManEndpoint+"/"+id, item); err != nil {
		return err
	}
	return nil
}
...
func (r *PFManResource) Delete(id string) error {
	if err := r.c.ModQuery("DELETE", bigip.GetBaseResource()+PFManEndpoint+"/"+id, nil); err != nil {
		return err
	}
	return nil
}
